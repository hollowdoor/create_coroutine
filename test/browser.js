...
function cc(cb){
    ...
    return function(){
        var ctx = this,
            ...
            prim = ['number', 'string', 'boolean', 'undefined'],
            solveAll = ['function', '[object Object]', '[object Array]'],
            events = [],
            type, temp;
        ...
        return new Promise(function(resolve, reject){
            function fn(next){
                ...
                if(prim.indexOf(type) !== -1){
                ...
                }else if(solveAll.indexOf(type) !== -1){

                    //console.log(typeof next.value === 'function' && fn.event);
                    if(typeof next.value === 'object' && next.value.sub){
                        //console.log('ok');
                        events.push(next.value.sub({next: function(v){
                                fn(gen.next(v));
                            }})
                        );
                        return;
                    ...
                    if(typeof next.value.pipe === 'function'){
                        if(typeof next.value.toArray === 'function'){
                            return next.value.toArray(function(v){
                                fn(gen.next(v));
                            });
                        }
                        try{
...
cc.yieldon = function(event, obj){

    function eve(){
        this.started = false;
        this.gen = null;
    }
    eve.prototype.sub = function(gen){
        if(this.started)
            return this;
        this.started = true;
    ...
    function ev(gen){
        var next;
        obj.addEventListener(event, callback, this);
        ...
        function callback(e){
            ...
            //if(gen.done)
                //return fn(gen.next(next.value));
            gen.next(e);
            //obj.removeEventListener(event, callback, this);
        }
...
},{"es6-promise":2,"polysolve":3,"setimmediate":5}],2:[function(require,module,exports){
...
},{"es6-promise":2,"setimmediate":5,"streamall":4}],4:[function(require,module,exports){
var Promise = require('es6-promise').Promise;
...
},{"es6-promise":2}],5:[function(require,module,exports){
(function (process){
...
cc(function * (){
    var output = document.getElementById('output'),
        clicked = yieldon('click', document.getElementById('clickme')),
        index = 0,
        event;
...
},{"../index.js":1,"es6-promise":2,"setimmediate":5}],7:[function(require,module,exports){
